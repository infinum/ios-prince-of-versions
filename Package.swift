...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "PrinceOfVersionsObjc", dependencies: [], path: "PrinceOfVersionsObjC"),
        .target(name: "PrinceOfVersions", dependencies: ["PrinceOfVersionsObjc"], path: "PrinceOfVersions"),
